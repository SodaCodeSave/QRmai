...
echo.
echo 请选择打包方式:
echo 1. 使用PyInstaller打包（默认）
echo 2. 使用Nuitka打包
echo.

choice /c 12 /m "请选择打包方式"
if %errorlevel% equ 2 goto :use_nuitka
goto :use_pyinstaller

:use_pyinstaller
cls
echo QRmai PyInstaller 打包脚本
echo ================================
echo.
